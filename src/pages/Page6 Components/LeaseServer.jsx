        ...
        <div className="container">
          <div className="LeaseServerHeader">
            ...
            <div className="headerGroup">
              <div className="cardHeaderGroup">
                <p data-aos="fade-right" data-aos-duration="1200">
                  In a bustling marketplace for bare-metal servers, we've opted
                  to give you MORE. Our standard solutions offer a unique
                  all-in-one package including servers, support, and BIG
                  bandwidth connectivity! We dare you to try it.
                </p>
              </div>
              <div className="cardHeaderGroup">
                <img
          ...
          <div className="LeaseServerBottom">
            <div className="bodyLeaseServer">
              <div className="bodyLeaseServerRight">
                {" "}
                <img
                  className="imgHeader"
                  data-aos="fade-up"
              ...
              <div className="LeaseServerBody">
                ...
                <p data-aos="fade-up" data-aos-duration="1200">
                  ...
                  Our network is constantly growing, so we never ask customers
                  to dial back their transit usage.
                </p>
              </div>
            </div>
          </div>
